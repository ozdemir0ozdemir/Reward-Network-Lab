...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	private final RowMapper<Restaurant> restaurantRowMapper = new RestaurantRowMapper();
	...
	public Restaurant findByMerchantNumber(String merchantNumber) {
		...
		return this.jdbcTemplate.queryForObject(sql, restaurantRowMapper, merchantNumber);
