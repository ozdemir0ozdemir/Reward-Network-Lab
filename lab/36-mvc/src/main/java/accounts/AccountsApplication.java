 ...
 *
 * 01: Open pom.xml or build.gradle for this project and check the dependencies.
 * - Note that we are using Spring Boot starter for Web
 * - Note that we are also using devtools
 *
 * 02: Run the application as a Spring Boot or Java application
...
/**
 * 12: Make this server listen on port 8088.
