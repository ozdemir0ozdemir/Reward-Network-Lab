...
public class AccountController {
	 ...
	 */
	// 02: Review the code that performs the following
	 ...
	 */
	// 04: Review the code that performs the following
	 ...
	 * response.
	 */
	// 06: Complete this method. Add annotations to:
	...
	private ResponseEntity<Void> entityWithLocation(Object resourceId) {
		...
		// -07: Set the 'location' header on a Response to URI of
	 ...
	 */
	// 10: Complete this method. Add annotations to:
	...
	public ResponseEntity<Void> addBeneficiary(@PathVariable long accountId,
		...
		// 11: Create a ResponseEntity containing the location of the newly
		// created beneficiary.
	 ...
	 * given id.
	 */
	// 12: Complete this method by adding the appropriate annotations to:
	...
	public void removeBeneficiary(@PathVariable long accountId, @PathVariable String beneficiaryName) {
		...
		if (account.getBeneficiaries().size() != 1 && (!b.getAllocationPercentage().equals(Percentage.zero()))) {
			...
			throw new RuntimeException("Logic to re-balance Beneficiaries not defined.");
		}
	...
	// 17 (Optional): Add a new exception-handling method
