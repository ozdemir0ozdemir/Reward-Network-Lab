...
public class RestaurantHealthCheckTest {
	...
	public void setUp() {
		...
		// 16b: Test custom health indicator
	...
	public void testHealthReturnsUpIfThereAreRestaurants() {
		...
		// 15a: Invoke the health() method on RestaurantHealthCheck object
		// (You will write health() method in the next step)
		Health result = this.restaurantHealthCheck.health();
	...
	public void testHealthReturnsDownIfThereAreNoRestaurants() {
		...
		// 15b: Invoke the health() method on RestaurantHealthCheck object
		// (You will write health() method in the next step)
		Health result = this.restaurantHealthCheck.health();
